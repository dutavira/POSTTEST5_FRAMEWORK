...
<body style="background-color: #E1FFB1;">
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-5">Detail Makanan</h1>
        <div class="d-grid gap-2 col-2 mx-auto">
        </div>
        <div class="card" style="background-color: #C7F2A4;">
            <div class="card-body">
                <table class="table table-borderless" style="background-color: #FCFFB2">
                    <tr>
                        <td><h4>Nama</h4></td>
                        <td><h4>:</h4></td>
                        <td><h4>{{$makanans->nama}}</h4></td>
                    </tr>
                    <tr>
                        <td><h4>Rasa/Varian</h4></td>
                        <td><h4>:</h4></td>
                        <td><h4>{{$makanans->rasa}}</h4></td>
                    </tr>
                    <tr>
                        <td><h4>Harga</h4></td>
                        <td><h4>:</h4></td>
                        <td><h4>{{$makanans->harga}}</h4></td>
                    </tr>
                    <tr>
                        <td><h4>Penjual</h4></td>
                        <td><h4>:</h4></td>
                        <td><h4>{{$makanans->penjual->nama}}</h4></td>
                    </tr>
                    </table>
            </div>
        </div>
