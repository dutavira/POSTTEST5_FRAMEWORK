...
<body style="background-color: #E1FFB1;">
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-5">Silahkan Login</h1>
        <div class="d-grid gap-2 col-2 mx-auto">
        </div>
        <div class="card">
            <div class="card-body" style="background-color: #C7F2A4;">
                @if(session('error'))
                ...
                <form action="{{url('/action-login')}}" method="POST">
                    ...
                    <div class="mt-3">
                        <p>Belum Punya Akun? <a class="text-primary" href="/register">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
